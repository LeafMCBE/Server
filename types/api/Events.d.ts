...
declare class Events extends EventEmitter {
  ...
  on(name: "onPlayerLeft", listener: (player: Player) => void): this;
  on(name: "onServerStart", listener: (server: Server) => void): this;
  ...
  emit(name: "onPlayerLeft", listener: (player: Player) => void): boolean;
